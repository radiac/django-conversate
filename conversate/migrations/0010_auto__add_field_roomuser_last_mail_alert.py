...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoomUser.last_mail_alert'
        db.add_column(u'conversate_roomuser', 'last_mail_alert',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoomUser.last_mail_alert'
        db.delete_column(u'conversate_roomuser', 'last_mail_alert')
