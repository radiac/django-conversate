...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RoomUser.alert'
        db.add_column(u'conversate_roomuser', 'alert',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'RoomUser.mail_alert'
        db.add_column(u'conversate_roomuser', 'mail_alert',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RoomUser.alert'
        db.delete_column(u'conversate_roomuser', 'alert')

        # Deleting field 'RoomUser.mail_alert'
        db.delete_column(u'conversate_roomuser', 'mail_alert')
    ...
    models = {
        ...
        u'conversate.roomuser': {
            ...
            'mail_alert': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
