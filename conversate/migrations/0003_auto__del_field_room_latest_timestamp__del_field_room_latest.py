...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Room.latest_timestamp'
        db.delete_column(u'conversate_room', 'latest_timestamp')

        # Deleting field 'Room.latest'
        db.delete_column(u'conversate_room', 'latest')


    def backwards(self, orm):
        # Adding field 'Room.latest_timestamp'
        db.add_column(u'conversate_room', 'latest_timestamp',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Room.latest'
        db.add_column(u'conversate_room', 'latest',
