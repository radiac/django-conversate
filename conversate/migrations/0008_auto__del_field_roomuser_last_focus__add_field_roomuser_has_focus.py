...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RoomUser.last_focus'
        db.delete_column(u'conversate_roomuser', 'last_focus')

        # Adding field 'RoomUser.has_focus'
        db.add_column(u'conversate_roomuser', 'has_focus',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RoomUser.last_focus'
        db.add_column(u'conversate_roomuser', 'last_focus',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RoomUser.has_focus'
        db.delete_column(u'conversate_roomuser', 'has_focus')
