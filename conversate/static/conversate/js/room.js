(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.room = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
/*!
	autosize 4.0.2
	license: MIT
...
(0, _jquery2.default)('document').ready(function () {
  ...
  **************************************************************************/
  ...
  var $window = (0, _jquery2.default)(window),
      ...
      $conv = (0, _jquery2.default)('.cnv_messages'),
      $content = $conv.parent(),
      $input = (0, _jquery2.default)('.cnv_input'),
      ...
      $users = (0, _jquery2.default)('.cnv_users'),
      $convTable = $conv.find('tr').parent(),
      $convTableCon = (0, _jquery2.default)('.cnv_table_con');

  // Prep content regex
  var urlPattern = new RegExp('\\b(' + 'https?://' // http:// or https://
  ...
  */
  ...
  PollManager.prototype = _jquery2.default.extend(PollManager.prototype, {
  ...
  */
  ...
  Status.prototype = _jquery2.default.extend(Status.prototype, {
    // Title flasher
    flasher: null,
    $timer: null,
    $note: null,
    ...
    render: function render($el) {
      ...
      // Add timer elements
      var $con = (0, _jquery2.default)('<div class="cnv_hourglass_con"></div>').appendTo($el);
      this.$hourglass = (0, _jquery2.default)('<div class="cnv_hourglass"></div>').appendTo($con);
      this.$note = (0, _jquery2.default)('<div class="cnv_hourglass_note"></div>').appendTo($con);
    ...
    wait: function wait(time) {
      ...
      var fx_interval = (FX_INTERVAL_MAX - FX_INTERVAL_MIN) * (this.room.poll.interval / settings.pollMax);
      fx_interval += FX_INTERVAL_MIN;
      _jquery2.default.fx.interval = parseInt(fx_interval, 10);

      // Show the timer
      this.$hourglass.animate({ width: 0 }, 0).animate({ width: '100%' }, this.room.poll.interval, 'linear');
    },
  ...
  */
  function Room() {
    ...
    for (var i = 0; i < $userThs.length; i++) {
      this.users[(0, _jquery2.default)($userThs[i]).text()] = (0, _jquery2.default)($userThs[i]);
    }
    ...
    $convTable.find('td:first-child').each(function () {
      $cell = (0, _jquery2.default)(this);
      cellTime = parseInt($cell.attr('data-time'), 10);
      // If time is in the past, check once a minute
      thisRoom.timeCells[unitTimeRelative(cellTime, now) || 2].push([$cell, cellTime]);
    });

    setInterval(function () {
      thisRoom.updateTimes(1);
    }, 0.5 * 1000);
    setInterval(function () {
      thisRoom.updateTimes(2);
    }, 30 * 1000);
    setInterval(function () {
      thisRoom.updateTimes(3);
    }, 60 * 30 * 1000);
    setInterval(function () {
      thisRoom.updateTimes(4);
    }, 60 * 60 * 12 * 1000);
    ...
    if (settings.remaining) {
      this.$history = (0, _jquery2.default)('<a href="javascript:void(0);" />').click(function (e) {
        e.preventDefault();
        thisRoom.fetchHistory();
      });
      this.$firstRow = $convTable.find('tr:first-child');
      this.$firstRow.find('td:last-child').html(this.$history);
      this._fetchHistory({
    ...
    // Listen for resize
    var observer = new _resizeObserverPolyfill2.default(function (entries, observer) {
  ...
  Room.prototype = _jquery2.default.extend(Room.prototype, {
    // PK of last message
    last: settings.last,
    ...
    _fetchHistory: function _fetchHistory(data) {
      ...
      for (i = 0; i < data.messages.length; i++) {
        m = data.messages[i];
        $newLine = this._mkLine(m.msgTime, m.user, m.content).insertAfter(this.$firstRow);
        this.timeCells[unitTimeRelative(m.msgTime)].push([$newLine.find('.cnv_time'), m.msgTime]);
      }

      if (this.remaining === 0) {
        this.$history.parent().text('No older messages');
      } else {
        this.$history.text(this.remaining + ' older message' + (this.remaining == 1 ? '' : 's'));
      }
    },
    ...
    _request: function _request(url, data) {
      // Queue requests
      if (this._requesting) {
    ...
    _response: function _response(data) {
      // Catch error
      if (!data.success) {
    ...
    _mkLine: function _mkLine(msgTime, user, content) {
      // Add new line and register time cell
      return (0, _jquery2.default)('<tr class="cnv_user_' + user + '">' + '<td class="cnv_time" data-time="' + msgTime + '"></td>' + '<td class="cnv_user">' + user + '</td>' + '<td class="cnv_content">' + this._render(content) + '</td>' + '</tr>');
    },
    _add: function _add(msgTime, user, content) {
      var $newLine = this._mkLine(msgTime, user, content).appendTo($convTable);
      this.timeCells[unitTimeRelative(msgTime)].push([$newLine.find('.cnv_time'), msgTime]);
    ...
    _render: function _render(content) {
      /** Render content */
      return content;
    },
    _updateUsers: function _updateUsers(users) {
      var $el,
          name,
          found = {},
          del = _jquery2.default.extend({}, this.users);
      for (var i = 0, l = users.length; i < l; i++) {
        ...
        if ($el) {
          ...
          $el = (0, _jquery2.default)('<th>' + name + '</th>').appendTo($row);
          $row.append((0, _jquery2.default)('<td/>')).appendTo($users);
          found[name] = $el;
        }

        // Update and pop from del
        $el.parent().attr('class', 'cnv_user_' + name + ' ' + (users[i].active ? users[i].has_focus ? 'cnv_active' : 'cnv_afk' : 'cnv_inactive'));
        $el.next().text(humanTime(users[i].last_spoke)).attr('title', 'Last ping: ' + humanTime(users[i].last_seen));
      }
    ...
    setTimeDiff: function setTimeDiff(serverTime) {
      this.timeDiff = time() - serverTime;
    },
    updateTimes: function updateTimes(unit) {
  ...
  */
  function Input(room) {
    ...
    var $inputTable = $input.find('table'),
        $col1 = (0, _jquery2.default)($inputTable.find('td').get(0)),
        $col2 = (0, _jquery2.default)($inputTable.find('td').get(1));
    $col2.html($col1.html());
    $col1.empty();

    // Make the input button autogrow
    (0, _autosize2.default)($message);
  ...
  Input.prototype = _jquery2.default.extend(Input.prototype, {
    submit: function submit() {
      ...
      _autosize2.default.update($message);
      $message.focus();
  ...
  **************************************************************************/
  ...
  if (!testEl('input container', $input) || !testEl('input form', $input_form) || !testEl('input field', $message) || !testEl('content container', $content) || !testEl('message container', $conv) || !testEl('message table', $convTable)) {
